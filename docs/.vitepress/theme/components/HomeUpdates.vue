        ...
        <li v-for="resource in resources" :key="resource.href">
          <div class="resource-heading">
            <div class="resource-primary">
              <a class="resource-title" :href="resource.internalHref">
                {{ resource.title }}
              </a>
              <a
                ...
                :aria-label="`访问 ${resource.title} 官方项目`"
                :title="`访问 ${resource.title} 官方项目`"
              >
                ↗
              </a>
