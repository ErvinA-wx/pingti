...
- 现在可以使用侧边栏中的图标为站点选择[自定义文本颜色](https://i.imgur.com/kXNRPjM.mp4)，并更新了反馈系统使其更显眼。

- 清理了剧集在线观看板块，移除了失效/不良站点，并收藏了几个表现最佳的站点，[前后对比](https://i.imgur.com/E3QTrUn.png)。
...
- 从 Audio DDL 中移除了 The Last Disaster，因其已关闭。

- 从 Live TV 中移除了 TOTV，因为现在所有频道似乎都是 YouTube 视频。

- 取消了 Plex 的星标，因其将远程流媒体设为[仅付费](https://www.plex.tv/blog/important-2025-plex-updates/)，同时提高了价格。

- 取消了 PSArips 的星标，因其下载过程非常烦人。

- 取消了 Bookracy 的星标，因其已出现问题一段时间。
