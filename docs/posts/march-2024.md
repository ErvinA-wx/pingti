...
:::info
这些更新帖仅包含主要更新。如需查看所有细微变更，可关注 [Commits Page](https://github.com/fmhy/FMHYedit/commits/main) 上的 GitHub 或 Discord 中的 [Updates Channel](https://redd.it/17f8msf)。
:::
...
- 已从 Android 中移除 Vendetta，因开发者已[关闭该项目](https://i.imgur.com/F4o2ela.png)。

- 已移除 TTV LOL，因其已停止工作。

- 取消标星 bypass.vip 和 FastForward，因为它们
  [不如以前好用](https://i.imgur.com/EMRcqX6.png) 了。

- 取消标星聊天机器人中的 Claude，因其需要邮箱和手机号注册，且
  效果不如以前。

- 取消标星 Harmonoid，因其已停止更新且在 GitHub 上有 100 多个问题。
