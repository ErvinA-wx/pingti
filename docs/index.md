...
title: 免费与开源替代方案导航
layout: home
description: 平替指南收录经过筛选的免费与开源软件、网站和工具替代方案，覆盖隐私、人工智能、影音、下载、开发与移动应用，并持续核验更新。

hero:
  name: 平替指南
  tagline: 发现更自由、更实用的免费与开源替代方案
  announcement:
    title: 关注网络隐私与数字自由 🔒
...
features:
  ...
  - title: 影视与流媒体
    link: /video
    details: 查找电影、电视剧、动漫相关的流媒体、下载与管理工具。
    icon: |
  ...
  - title: BT 下载
    ...
    link: /torrenting
    details: 了解 BitTorrent 客户端、站点、追踪器与安全实践。
  ...
  - title: Android / iOS
    ...
    link: /mobile
    details: Android 与 iOS 应用、工具和使用指南。
  ...
  - title: Linux / macOS
    ...
    link: /linux-macos
    details: Linux 与 macOS 软件、系统工具和使用指南。
  ...
  - title: 其他资源
    ...
    link: /misc
    details: 食品、旅行、新闻、购物、趣味网站等综合主题。
---

## 面向中文用户的实用替代方案

平替指南帮助我们快速找到常用软件、网站和在线服务的免费或开源替代品。内容按真实使用场景分类，并补充隐私、安全、兼容性和使用门槛等信息，方便在尝试前做出判断。

## 我们如何筛选和维护

- 优先收录可验证、仍在维护且用途明确的资源，并标出社区重点推荐项。
- 参考 FMHY 社区持续更新的公开资料，完成简体中文本地化后再发布。
- 自动同步只负责发现变化；链接、术语和页面结构还会经过规则校验与人工抽查。
- 对失效、恶意或明显误导的条目及时移除，并在更新日志中保留变更记录。

完整标准、来源披露与更正方式见[编辑与内容规范](/other/editorial-policy)。
